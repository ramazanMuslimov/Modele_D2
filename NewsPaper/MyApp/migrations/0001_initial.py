...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('categoryTrough', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyApp.category')),
                ('postTrough', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyApp.post')),
            ],
        ),
        migrations.AddField(
            model_name='post',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateCreation', models.DateTimeField(auto_now_add=True)),
                ('reting', models.SmallIntegerField(default=0)),
                ('commentPost', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyApp.post')),
